              ...
              <TabsContent value="esterno" className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {imageCategories.esterno.map((img, index) => (
                    <div key={`esterno-${index}`} className="aspect-w-4 aspect-h-3 overflow-hidden rounded-lg">
                      <img 
                        src={img} 
              ...
              <TabsContent value="atrio" className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {imageCategories.atrio.map((img, index) => (
                    <div key={`atrio-${index}`} className="aspect-w-4 aspect-h-3 overflow-hidden rounded-lg">
                      <img 
                        src={img} 
              ...
              <TabsContent value="sale" className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {imageCategories.sale.map((img, index) => (
                    <div key={`sale-${index}`} className="aspect-w-4 aspect-h-3 overflow-hidden rounded-lg">
                      <img 
                        src={img} 
